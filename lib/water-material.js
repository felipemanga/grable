...
THREE.ShaderLib['water'] = {
  ...
  vertexShader: [
    ...
    'void main()',
    '{',
    '  nrmSunDirection = normalize( sunDirection );',
  ...
  fragmentShader: [    
    ...
    '{',
    '  vec3 reflection = normalize(reflect(-nrmSunDirection, surfaceNormal));',
    '  float direction = max(0.0, dot(eyeDirection, reflection));',
    '  specularColor += pow(direction, shiny) * sunColor * spec;',
    '  diffuseColor += max(dot(nrmSunDirection, surfaceNormal), 0.0) * sunColor * diffuse;',
    '}',
    ...
    '  vec3 albedo = mix(sunColor * diffuseLight * shadow * 0.3 + scatter, (vec3(0.1) + reflectionSample * 0.9 * shadow + reflectionSample * specularLight), reflectance);',
