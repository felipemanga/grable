    ...
    build:function( mesh, gen ){
        ...
        if( this.parent && this.points ){
            var size = 11,
                ...
                originTextureY = this.uvId - Math.floor(this.uvId),
                targetTextureY = this.parent.uvId - Math.floor(this.parent.uvId);
            
            originTextureY = 1 - Math.floor(this.uvId / gen.tiles.x + originTextureY ) / gen.tiles.y;
            if( targetTextureY == 0 ) targetTextureY = 1;
            targetTextureY = 1 - Math.floor(this.uvId / gen.tiles.x + targetTextureY ) / gen.tiles.y;
