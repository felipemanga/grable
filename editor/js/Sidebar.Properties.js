...
Sidebar.Properties = function ( editor ) {
	...
	var entityTab = new UI.Text( 'E' ).onClick( onClick );

	var tabs = new UI.Div();
	tabs.setId( 'tabs' );
	tabs.add( objectTab, geometryTab, materialTab, entityTab );
	container.add( tabs );
	...
	var entity = new UI.Span().add(
		new Sidebar.Entity( editor )
	);
