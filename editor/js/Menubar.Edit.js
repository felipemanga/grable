...
Menubar.Edit = function ( editor ) {
	...
	option.onClick( function () {
		...
		var object = editor.selected, src = editor.selected;
		...
		var srcScripts = editor.scripts[ src.uuid ];
		if( srcScripts ){

			for( var i=0; i<srcScripts.length; ++i )
			{
				editor.execute( new AddScriptCommand( object, Object.assign({}, srcScripts[i] ) ) );
			}
